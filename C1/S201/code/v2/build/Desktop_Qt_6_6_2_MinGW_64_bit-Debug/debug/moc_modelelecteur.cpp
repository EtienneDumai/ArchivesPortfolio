...
Q_CONSTINIT static const qt_meta_stringdata_CLASSModeleLecteurENDCLASS_t qt_meta_stringdata_CLASSModeleLecteurENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(14, 24),  // "envoyerInfosMajInterface"
        QT_MOC_LITERAL(39, 0),  // ""
        QT_MOC_LITERAL(40, 19),  // "ImageDansDiaporama*"
        QT_MOC_LITERAL(60, 5),  // "image"
        QT_MOC_LITERAL(66, 17),  // "demandeAvancement"
        QT_MOC_LITERAL(84, 17)   // "demandeReculement"
    },
    "ModeleLecteur",
    "envoyerInfosMajInterface",
    "",
...
Q_CONSTINIT const QMetaObject ModeleLecteur::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSModeleLecteurENDCLASS_t,
        ...
        // method 'envoyerInfosMajInterface'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<ImageDansDiaporama *, std::false_type>,
...
void ModeleLecteur::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->envoyerInfosMajInterface((*reinterpret_cast< std::add_pointer_t<ImageDansDiaporama*>>(_a[1]))); break;
        case 1: _t->demandeAvancement(); break;
        case 2: _t->demandeReculement(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ModeleLecteur::*)(ImageDansDiaporama * );
            if (_t _q_method = &ModeleLecteur::envoyerInfosMajInterface; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ModeleLecteur::envoyerInfosMajInterface(ImageDansDiaporama * _t1)
{
